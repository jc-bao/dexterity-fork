...
from dexterity.models.hands import roller_hand_constants as consts
...
class RollerHand(dexterous_hand.DexterousHand):
  """Shadow Dexterous Hand E Series."""

  def _build(self, name: str = "roller_hand") -> None:
    ...
    self._mjcf_root = mjcf.from_path(str(consts.ROLLER_HAND_XML))
