...
_TEXTURE_PATH = _SRC_ROOT / "manipulation" / \
  "props" / "openai_cube" / "openai_cube.png"


class Sphere(primitive.Primitive):
  ...
  def _build(
    ...
    """
    super()._build(geom_type="sphere", size=[size] * 3, name=name, friction=[10,1,0.001])
