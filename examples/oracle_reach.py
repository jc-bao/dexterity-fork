...
flags.DEFINE_enum("task_name", "state_dense", _REACH_TASKS,
                  "Which reach task to load.")
flags.DEFINE_integer("seed", None, "RNG seed.")
flags.DEFINE_integer("num_episodes", 1, "Number of episodes to run.")
flags.DEFINE_boolean(
  "render", False, "Whether to render the episode and save to disk.")
flags.DEFINE_string("save_dir", "./temp",
                    "Where to save the video, if rendering.")
